...
function Hero2() {
  return (
    <div className="w-full h-full z-10 relative p-20 ">
      <div className="w-full h-[80%] bg-[#0f1a2c] rounded-lg flex p-10">
        <h1 className="text-5xl font-bold">About</h1>
        <div className="hero-l w-1/2 flex items-center justify-center">
          <img
