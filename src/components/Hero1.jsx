  ...
  <Navbar/>
     ...
     <div className="shadow1 -z-10 w-[70vh] h-[70vh] top-52 -right-8 rounded-full absolute"></div>
      <div className="hero-l w-1/2 max-md:w-full py-16 flex  max-md:items-center flex-col gap-16 justify-center">
        <h1 className="text-7xl max-md:text-[10vw] max-md:text-center text-nowrap  font-bold text-1 textww">Hi I’m Kenil</h1>
        <p className="w-80 text-lg max-md:text-center text-1">
          I'm a full-stack developer with 5 years of experience using React and
          NodeJS. Reach out if you'd like to learn more!
        </p>
        <button className=" w-40 btn opacity-0 ">Contact Me</button>
      </div>
